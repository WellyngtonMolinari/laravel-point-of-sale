...
<div class="container">
    <div class="row justify-content-center">
            ...
            <div class="card bg-pattern">
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p class="text-white-50">Fazer <a href="{{ route('login') }}" class="text-white ms-1"><b>Log in</b></a></p>
                    </div> <!-- end col -->
                </div>
                        <!-- end row -->
        ...
        <footer class="footer footer-alt">
            2023 - <script>document.write(new Date().getFullYear())</script> &copy; System by <a href="" class="text-white-50">TechMind</a> 
        </footer>
