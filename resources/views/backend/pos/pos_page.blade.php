...
<button type="submit" class="btn btn-sm btn-success" style="margin-top:-2px ;"> <i class="fas fa-check"></i> </button>   
    ...
    <td> <a href="{{ url('/cart-remove/'.$cart->rowId) }}"><i class="fas fa-trash-alt" style="color:#000000"></i></a> </td>
                            </tr>
...
<p><h2 class="text-white"> Total </h2> <h1 class="text-white"> {{ Cart::total() }}</h1>   </p>
    ...
    <td>
        <button type="submit" style="font-size: 20px; color: #38ff7e; background: transparent; border: none; ">
